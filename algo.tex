...
Dzięki funkcji def \textit{partition} następuje podzielenie większych problemów na mniejsze. Wykorzystany zostanie \textit{pivot}, czyli element który pozwoli wyznaczyć dwa podproblmy. Elementy na lewo od \textit{pivot'a} będą od niego mniejsze, zaś po jego prawej stronie, większe.
